 ...
 *
 * ```ts
 * import { interval, fromEvent } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 * import { map, startWith, takeUntil, endWith } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
