 ...
 * import { throttleTime } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
 ...
 *
 * ```ts
 * import { fromEvent, asyncScheduler } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 * import { throttleTime, withLatestFrom } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
