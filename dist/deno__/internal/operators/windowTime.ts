 ...
 * import { windowTime, map, mergeAll, take } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
 ...
 * ```ts
 * import { fromEvent } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 * import { windowTime, mergeAll } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
 * const clicks = fromEvent(document, 'click');
 * const result = clicks.pipe(
