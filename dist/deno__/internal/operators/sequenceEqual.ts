 ...
 * ```ts
 * import { from, fromEvent } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 * import { sequenceEqual, bufferCount, mergeMap, map } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
 * const codes = from([
 *   'ArrowUp',
 *   'ArrowUp',
