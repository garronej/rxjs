 ...
 * ## Example
 * ```ts
 * import { timer, interval } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 * import { map, tap, retryWhen, delayWhen } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
