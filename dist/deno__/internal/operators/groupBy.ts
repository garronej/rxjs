 ...
 * import { mergeMap, groupBy, reduce } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
 * of(
 ...
 * ```ts
 * import { of } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 * import { groupBy, map, mergeMap, reduce } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
 * of(
 *   { id: 1, name: 'JavaScript' },
 *   { id: 2, name: 'Parcel' },
