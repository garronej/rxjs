...
import { MonoTypeOperatorFunction, SchedulerLike, TeardownLogic, SchedulerAction } from '../types.ts';
import { asap as asapScheduler } from '../scheduler/asap.ts';
 ...
 *
 * ```ts
 * import { of, merge } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
 * const a = of(1, 2, 3);
 * const b = of(4, 5, 6);
 *
 ...
 *
 * ```ts
 * import { of, merge, asyncScheduler } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 * import { subscribeOn } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
