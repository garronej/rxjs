 ...
 * import { shareReplay, take } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
 ...
 * import { interval, Observable, defer } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 * import { shareReplay, take, tap, finalize } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
