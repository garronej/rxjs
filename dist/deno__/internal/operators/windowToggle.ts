 ...
 * ```ts
 * import { fromEvent, interval, EMPTY } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 * import { windowToggle, mergeAll } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
