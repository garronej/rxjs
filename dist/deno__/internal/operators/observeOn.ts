 ...
 * ```ts
 * import { interval, animationFrameScheduler } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 * import { observeOn } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
