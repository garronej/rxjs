...
export class Observable<T> implements Subscribable<T> {
   ...
   * ```ts
   * import { interval } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
   *
   ...
   * ```ts
   * import { interval } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
   * import { take } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
   *
  ...
  /**
   * @nocollapse
   * @deprecated In favor of iif creation function: import { iif } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
   */
  static if: typeof iif;
  /**
   * @nocollapse
   * @deprecated In favor of throwError creation function: import { throwError } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
   */
   ...
   * ```ts
   * import { interval } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
   * import { map, filter, scan } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
   *
   * interval(1000)
   *   .pipe(
   *     filter(x => x % 2 === 0),
