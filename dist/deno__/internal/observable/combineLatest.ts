 ...
 * ```ts
 * import { combineLatest, timer } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
 ...
 * ```ts
 * import { combineLatest, of } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 * import { delay, startWith } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
 ...
 * ```ts
 * import { combineLatest, of } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 * import { map } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
