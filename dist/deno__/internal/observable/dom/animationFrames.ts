 ...
 *
 * ```ts
 * import { animationFrames } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 * import { map, takeWhile, endWith } from 'rxjs/operators DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
 ...
 *
 * ```ts
 * import { animationFrames, TimestampProvider } from 'rxjs DENOIFY: DEPENDENCY UNMET (BUILTIN)';
 *
